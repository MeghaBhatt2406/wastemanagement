...
// Add these routes
export const GET_USER_PROFILE_ROUTE = `${USER_ROUTE}/profile`;
export const UPDATE_USER_PROFILE_ROUTE = `${USER_ROUTE}/profile`;
export const UPLOAD_PROFILE_IMAGE_ROUTE = `${USER_ROUTE}/upload-profile-image`;
