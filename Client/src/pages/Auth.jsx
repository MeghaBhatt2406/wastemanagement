...
//       <div className="h-[110vh] w-[110vw] bg-white border-2 border-white text-opacity-90 shadow-2xl md:w-[90vw] lg:w-[70vw] xl:w-[60vw] rounded-3xl grid xl:grid-cols-2 ">
//         <div className="flex flex-col items-center sm:gap-10 gap-5">
//           <div className="flex-col items-center justify-center felx">
//             <div className="flex items-center justify-center " style={{ marginTop: "27px", marginLeft: "47px" }}>
...
//           <img src={background} alt="Background icon" className="h-[100vh]" />
//         </div>
//       </div>
//     </div>
//   );
              ...
              >
                ...
                <div className="relative">
                  <Input
                    ...
                    placeholder="Enter Password"
                    className="p-6 rounded-full pr-12"
                    value={password}
                    onChange={(e) => setPassword(e.target.value)}
                  />
                  <button
              ...
              <TabsContent value="signup" className="flex flex-col gap-5">
                ...
                <div className="relative">
                  <Input
                    type={showPassword ? "text" : "password"}
                    placeholder="Enter Password"
                    className="p-5 sm:p-6 rounded-full pr-12"
                    value={password}
                    onChange={(e) => setPassword(e.target.value)}
                  />
                  <button
