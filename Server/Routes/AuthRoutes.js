...
import { getUserInfo, login, logOut, signup,changePassword } from "../controllers/AuthController.js";
...
authRouter.post("/change-password", validateRequestBody, verifyToken, changePassword);
